  ...
  return (
    <div>
      ...
      <div className='flex justify-center items-center mb-1'>
        <div className='mr-1'>Escolha uma perícia: </div> 
        <div>
          <select className='p-1' name="versatile-option-1" id="versatile-option-1" value={firstVersatileChoice.name} onChange={e => setFirstVersatileChoice(new VersatileChoiceSkill(e.target.value as SkillName))}>
      ...
      <div className="flex justify-center items-center mb-1">
        ...
        <select className='p-1' name="versatile-option-2-type" id="versatile-option-2-type" value={secondVersatileChoice.type} 
      ...
      <div className="flex justify-center items-center mb-1">
        <div className='mr-1'>Escolha {secondChoiceTitle}:</div> 
        <div>
          <select className='p-1' name="versatile-option-2" id="versatile-option-2"
